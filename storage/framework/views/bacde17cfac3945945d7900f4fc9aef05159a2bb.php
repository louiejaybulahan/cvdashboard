...
jQuery(document).ready(function () {
    ...
    jQuery('#btnRebuild').click(function(){
        jQuery.getJSON('<?php echo e(route('listhealth.rebuildfilter')); ?>',function(data){
            location.reload();
        });
    });
...
function jsSearchData(page){
    ...
    jQuery('#loading').show();
    jQuery.ajax({
        type: "POST", url:'<?php echo e(route('listhealth.search')); ?>', data: dataString, dataType: 'json', cache: false,        
        error: function (request, status, error) { jsMessage('Error Request'); },
        success: function (data) {              
            startPage = 1;
            endPage = data.pages;
    ...
    $('#resultTable').tabulator("setData",'<?php echo e(route('listhealth.search')); ?>', dataString, ajaxConfig);
    */
    return false;
}
function jsShowSummary(){
    event.preventDefault();
    jQuery.get('<?php echo e(route('listhealth.summary')); ?>', function(html) { jQuery('#divSummary').html(html).modal({width:'1000px'}); });
    return false;
}
</script>
<?php $__env->stopSection(); ?>
...
<?php echo e(Form::open(['route' => 'listhealth.search','class' => 'stdform','id' => 'formUser','novalidate' => 'novalidate' ])); ?>        
<div class="widgetbox">
        ...
        <div class="one_fourth">  
            ...
            <p>
                ...
                <select id="hh_status" name="hh_status" class="chosen" multiple="multiple" data-placeholder="-">                    
                    <?php $__currentLoopData = $_hh_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <p>
                ...
                <select id="remarks" name="remarks" class="chosen" multiple="multiple" data-placeholder="-">                    
                    <?php $__currentLoopData = $_remarks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($r); ?>"><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
        ...
        <div class="one_fourth">             
            <p>
                ...
                <select id="hc_name" name="hc_name" class="chosen" multiple="multiple" data-placeholder="-">                    
                    <?php $__currentLoopData = $_hc_name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($r); ?>"><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <p>
                ...
                <select id="hc_region" name="hc_region" class="chosen" multiple="multiple" data-placeholder="-">                    
                    <?php $__currentLoopData = $_hc_region; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($r); ?>"><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <p>
                ...
                <select id="hc_province" name="hc_province" class="chosen" multiple="multiple" data-placeholder="-">                    
                    <?php $__currentLoopData = $_hc_province; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($r); ?>"><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <p>
                ...
                <select id="hc_muni" name="hc_muni" class="chosen" multiple="multiple" data-placeholder="-">                    
                    <?php $__currentLoopData = $_hc_muni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($r); ?>"><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <p>
                ...
                <select id="hc_brgy" name="hc_brgy" class="chosen" multiple="multiple" data-placeholder="-">                    
                    <?php $__currentLoopData = $_hc_brgy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($r); ?>"><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
        ...
        <div class="one_fourth">
            <p>
                ...
                <select id="dom_hc_name" name="dom_hc_name" class="chosen" multiple="multiple" data-placeholder="-">                    
                    <?php $__currentLoopData = $_dom_hc_name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($r); ?>"><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <small class="desc" style="margin:0px;">Select as many health center barangay</small>
            ...
            <p>
                ...
                <select id="dom_hc_region" name="dom_hc_region" class="chosen" multiple="multiple" data-placeholder="-">                    
                    <?php $__currentLoopData = $_dom_hc_region; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($r); ?>"><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <small class="desc" style="margin:0px;">Select as many health center region</small>
            ...
            <p>
                ...
                <select id="dom_hc_province" name="dom_hc_province" class="chosen" multiple="multiple" data-placeholder="-">                    
                    <?php $__currentLoopData = $_dom_hc_province; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($r); ?>"><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <p>
                ...
                <select id="dom_hc_muni" name="dom_hc_muni" class="chosen" multiple="multiple" data-placeholder="-">                    
                    <?php $__currentLoopData = $_dom_hc_muni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($r); ?>"><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <small class="desc" style="margin:0px;">Select as many health center municipality</small>
            ...
            <p>
                ...
                <select id="dom_hc_brgy" name="dom_hc_brgy" class="chosen" multiple="multiple" data-placeholder="-">                    
                    <?php $__currentLoopData = $_dom_hc_brgy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($r); ?>"><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <small class="desc" style="margin:0px;">Select as many health center barangay</small>
            ...
            <p>
                ...
                <select id="pregnant" name="pregnant" class="chosen" multiple="multiple" data-placeholder="-">                    
                    <?php $__currentLoopData = $_pregnant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($r); ?>"><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <p>
                ...
                <select id="child" name="child" class="chosen" multiple="multiple" data-placeholder="-">                    
                    <?php $__currentLoopData = $_child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($r); ?>"><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
