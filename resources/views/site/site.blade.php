...
<div class="one_half">
	...
	<div class="content">
                ...
                <div id="dashresult"></div>	<br>
                 ...
                 <br clear="all">                   
            <!-- <div id="dashresult2"></div>	<br>
				 <div id="dashexport"><a href="#" id="exportbtn2" class="btn btn2 btn_book" style="background-color: rgb(247, 247, 247);"><span>Export Result to Excel(.xlsx)</span></a></div>					             
                 <br clear="all">     -->              
	
	
				<div>
                    	<!--<div class="widgetbox uncollapsible ">
                            <div class="title "><h2 class="general"><span id="header_result">[$Average Graph], {$YEAR | $PERIOD | $MONTH_2}</span></h2></div>
