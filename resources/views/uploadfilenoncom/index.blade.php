...
@section('title','Upload Non Complaint FDS, Health Center, Education','selected')
...
function jsRender(){
    jQuery('#displayOutput').attr('src',"{{ route('uploadfilenoncom.renderfile') }}");
    return false;
}
</script>
@endsection
...
{{ Form::open(['route' => 'uploadfilenoncom.loadfile','class' => 'stdform stdform2','id' => 'frmUpload','novalidate' => 'novalidate','onsubmit' => 'return false;']) }}        
<div class="one_half">	
